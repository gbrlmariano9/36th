...
$( document ).ready(function() {
  ...
  $("#presentation_tbl").DataTable().clear(); 
    $("#presentation_tbl").DataTable({
      ...
      order: [],
      ajax: {
        url: "<?php echo e(route('getPresentationData')); ?>",
        dataType: "json",
        type: "POST",
        data: {
  ...
  $('body').on('click', '.btn-export', function() {
    ...
    $.ajax({ 
                type: 'POST',
                url: "<?php echo e(route('getPresenterInfo')); ?>",
                data: {
                    _token: "<?php echo e(csrf_token()); ?>",
                    id: id,
                },
                ...
                if(data[0].presentationType == "Poster"){
                  //$("#imagePoster").attr("src","http://localhost/csd/public/Entry-Form_35th-R4D-Conference_files/image003.png");
                  //$("#imagePaper").attr("src","http://localhost/csd/public/Entry-Form_35th-R4D-Conference_files/image002.png");

                  $("#imagePoster").attr("src","https://ugnaypalay.philrice.gov.ph:441/csd/36th/public/Entry-Form_35th-R4D-Conference_files/image003.png");
                  $("#imagePaper").attr("src","https://ugnaypalay.philrice.gov.ph:441/csd/36th/public/Entry-Form_35th-R4D-Conference_files/image002.png");
                  
                }else{
                  //$("#imagePoster").attr("src","http://localhost/csd/public/Entry-Form_35th-R4D-Conference_files/image002.png");
                  //$("#imagePaper").attr("src","http://localhost/csd/public/Entry-Form_35th-R4D-Conference_files/image003.png");

                  $("#imagePoster").attr("src","https://ugnaypalay.philrice.gov.ph:441/csd/36th/public/Entry-Form_35th-R4D-Conference_files/image002.png");
                  $("#imagePaper").attr("src","https://ugnaypalay.philrice.gov.ph:441/csd/36th/public/Entry-Form_35th-R4D-Conference_files/image003.png");
                }
                ...
                $('#email_presenter').text(data[0].emailPresenter);
                  ...
                  Export2Word('exportContent','36th Ugnay Palay R4D Conf_ENTRY form_'+data[0].trackingNumber);
                }
            });
