...
<head>
  ...
  <style>
        body {
            background-image: url('/csd/36th/public/ugnaypalayapp/bg.png');
...
<body>
  ...
  <div class="offcanvas offcanvas-start" tabindex="-1" id="offcanvasSidebar" aria-labelledby="offcanvasSidebarLabel">
    <div class="offcanvas-header">
        <img src="/csd/36th/public/ugnaypalayapp/logo.png" width="200px" height="60px" alt="Logo">
                                  ...
                                  <div class="row">
                                      <div class="col-md-4 mb-4">
                                          <div class="card d-flex flex-row align-items-center">
                                              <img src="/csd/36th/public/assets_website/img/r4d_speakers/FTL.png" alt="Speaker 1" class="card-img-left" style="width: 120px; height: 120px;">
                                              <div class="card-body">
                      ...
                      <div class="col-md-4 mb-4">
                          <div class="card">
                              <a href="https://drive.google.com/file/d/1V2y5_TM7O3vmV2qJpEzqvKZcDoK6x_82/view?usp=sharing" target="_blank"> 
                                <img src="/csd/36th/public/ugnaypalayapp/souvenir_pic.png" class="card-img-top" alt="Souvenir 1"> 
                              </a>
                              <!-- <div class="card-body">
      ...
      <div class="modal-dialog modal-fullscreen">
          <div class="modal-content">
              ...
              <div class="modal-body">
                  ...
                  <a href="/csd/36th/public/ugnaypalayapp/venue_map.png" data-lightbox="venue-map" data-title="Venue Map">
                      <img src="/csd/36th/public/ugnaypalayapp/venue_map.png" class="img-fluid" alt="Venue Map" style="border: 1px solid #ddd;">
                  </a>
              </div>
          </div>
      </div>
          ...
          <div class="accordion" id="faqsAccordion">
            ...
            <div class="accordion-item">
              ...
              <div id="collapseFour" class="accordion-collapse collapse" aria-labelledby="headingFour" data-bs-parent="#faqsAccordion">
                <div class="accordion-body">
                  Anyone can register to the 36th Ugnay Palay.  We are inviting the rice science community and its stakeholders to attend the Conference. Registration opened in September 2024. 
                </div>
              </div>
            </div>
    ...
    <div class="modal-dialog modal-fullscreen">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <img src="/csd/36th/public/ugnaypalayapp/philricelogo.png" alt="" class="img-fluid">
                <!-- <h6>Follow Us:</h6>
                <p>
  ...
  <script type="text/javascript">
    $(document).ready(function() {
      $('body').on('click', '#submitComment', function(event) {
        ...
        $.ajax({ 
          type: 'POST',
          url: "<?php echo e(route('saveParticipantProfile2')); ?>",
          data: {
