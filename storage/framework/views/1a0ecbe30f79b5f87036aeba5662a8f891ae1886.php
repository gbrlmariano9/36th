  ...
  <body>
    ...
    <div>
      <div class="header" style="height: auto;">
        ...
        <div>
          <picture>
            <source media="(min-width: 700px)" srcset="../resources/bg/36thbanner.png">
            <img src="../resources/bg/Banner1.png" height="100%" width="100%" alt="">
          </picture>
          
          <p id="invCode" style="display:none"><?php echo e($invitationCode); ?></p>
        </div>      
      </div>
              ...
              <div class="form-section">
                <div class="form-group">
                  <label for="philrice" class="form-label">
                    <i class="fa fa-id-card _icon" aria-hidden="true"></i> Are you from PhilRice?<span class="tx-danger">*</span>
                  </label>
                ...
                <div class="form-group">
                  <label for="participantType" class="form-label">
                    <i class="fa fa-user _icon" aria-hidden="true"></i> Please select whether you are a presenter or a participant.<span class="tx-danger">*</span>
                  </label>
        ...
        <div class=" animatedFadeIn" style="display:none;" id="regForm">
            ...
            <div id="wizard1">
                ...
                <div class="row row-sm" style="display: none" id="philriceDetails">
                      ...
                      <div class="form-group col-sm-3 d-flex align-items-end">
                        <select class="custom-select" id="philricePosition" required>
                          ...
                          <?php foreach($getPositions as $row): ?>
                          <option value="<?php echo e($row->position_name); ?>"><?php echo e($row->position_name); ?></option>
                          <?php endforeach; ?>
              ...
              <section  style="display:none" id="accommodationDetails">
                <h4><i class="fa fa-car _icon" aria-hidden="true" style="color: #008000;"></i> <i class="fa fa-bed _icon" aria-hidden="true" style="color: #008000;"> </i><i class="fa fa-cutlery _icon" aria-hidden="true" style="color: #008000;"></i> Arrival, Accommodations, Food</h4>
                <p class="mg-b-20">No registration fee will be charged but participants
  will please shoulder and arrange their travel and accommodation expenses. You may refer to <a href="https://drive.google.com/file/d/1E_PrvbQpzwDj3ti7RNxiaD6Cg8GcN7wa/view?usp=sharing" target="_blank">this link</a> for the list of hotel recommendations. For booking inquiries, please contact the hotels directly. PhilRice will provide vehicles to fetch and ferry participants from their respective hotels to CBC Plenary Hall. </p>
                <div class="row row-sm">
                <div class="form-group col-sm-6">
                  <label>Estimated Date of Arrival<span class="tx-danger">*</span></label>
                    <input type="date" class="form-control" placeholder="" id="arrivalDate" min="">
                  </div><!-- col -->
                <div class="form-group col-sm-6">
                  <label>Estimated Time of Arrival<span class="tx-danger">*</span></label>
                    <input type="time" class="form-control" disabled placeholder="" id="arrivalTime">
                  </div><!-- col -->
                  <div class="form-group col-sm-6">
                    <label>Estimated Date of Departure<span class="tx-danger">*</span></label>
                    <input type="date" class="form-control" disabled placeholder="" id="departureDate" min="">
                  </div><!-- col -->
                  <div class="form-group col-sm-6">
                  <label>Estimated Time of Departure<span class="tx-danger">*</span></label>
            ...
            <button type="submit" id="toPresenterForm" style="display:none; color: white;" class="btn btn-success pd-x-20" disabled>Next Page</button> <?php /* disabled dapat ito */ ?>
            <br><br>
        ...
        <div class="card card-body pd-lg-25" id="registrationSubmitted" style="display:none">
          <div class="confirmation-message">
            <h2 class="confirmation-title">Thank you for registering for the 36<sup>th</sup> Ugnay Palay National Rice R4D Conference!</h2>
    ...
    <div class="content-body">
      ...
      <div class="component-section no-code form-group col-lg"id="entForm">
          ...
          <h6 id="requiredFields2" style="color: red; font-style: italic;">Fields marked with an * are required</h6>
                ...
                <div class="row row-sm form-group col-lg bg" id="presentationTypes">
                  ...
                  <div class="form-group col-sm-3">
                    ...
                    <select class="custom-select" id="thematicArea" required>
                      ...
                      <option value="Sustainable Rice Farming: Green Technologies and Water Management">Sustainable Rice Farming: Green Technologies and Water Management</option>
                      <option value="Advancing Climate-smart Agriculture Practices and Enhancing Climate Resilience in Rice Farming">Advancing Climate-smart Agriculture Practices and Enhancing Climate Resilience in Rice Farming</option>
                      <option value="Digital Agriculture: Harnessing Technology for Fram Efficiency">Digital Agriculture: Harnessing Technology for Farm Efficiency</option>
                      <option value="Farmer-centered Innovations for Increased Productivity">Farmer-centered Innovations for Increased Productivity</option>
                      <option value="Youth in Agriculture">Youth in Agriculture</option>
                    </select>
                  </div>
            ...
            <button type="submit" id="submitPresenter" style="background-color:#008000; color: white;" class="btn pd-x-20" disabled>Submit</button><?php /*  dapat nakadisabled */ ?>
  ...
  <script>
    ...
    $(document).ready(function() {
        $("#uploadForm").submit(function(e) {
            ...
            $.ajax({
                type: "POST",
                url: '<?php echo e(route('uploadd')); ?>', // Use Laravel's route helper
                data: formData, 
                contentType: false,
                processData: false,
                headers: {
...
$(document).ready(function() {
  ...
  $('#submitParticipant').on("click", function (e) {
    ...
    $.ajax({ 
        type: 'POST',
        url: "<?php echo e(route('saveParticipantProfile')); ?>",
        data: {
  ...
  function handlePresenterData(data){
    ...
    $otherDiet = $('#otherDiet').val();
      ...
      $.ajax({ 
        type: 'POST',
        url: "<?php echo e(route('savePresenterProfile')); ?>",
        data: {
            _token: "<?php echo e(csrf_token()); ?>",
            invitationCode: $invitationCode,
            email: $email,
  ...
  $('#submitPresenter').on("click", function (e) {
    ...
    $.ajax({ 
      type: 'POST',
      url: "<?php echo e(route('savePresenterProfile1')); ?>",
      data: {
          _token: "<?php echo e(csrf_token()); ?>",
          invitationCode : invitationCode,
